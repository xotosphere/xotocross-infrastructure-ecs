...
resource "aws_lb_listener" "xtcross-https-redirection" {
  count             = (local.hasCert && data.aws_lb_listener.xtcross-https-redirection == null) ? 1 : 0
  load_balancer_arn = data.aws_lb.xtcross-loadbalancer.arn
  port              = 80
  protocol          = "HTTP"
...
resource "aws_lb_listener" "xtcross-http-listener" {
  count             = data.aws_lb_listener.xtcross-http-listener == null ? 1 : 0
  load_balancer_arn = data.aws_lb.xtcross-loadbalancer.arn
...
resource "aws_lb_listener_rule" "xtcross-http-listener-rule" {
  ...
  listener_arn = data.aws_lb_listener.xtcross-http-listener != null ? data.aws_lb_listener.xtcross-http-listener.arn : aws_lb_listener.xtcross-http-listener[0].arn
