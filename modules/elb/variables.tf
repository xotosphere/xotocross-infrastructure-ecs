...
# variable "xotocross-certificate-arn" {description = "xotocross arn of the certificate to use for the alb listener" }
variable "xotocross-ports" { description = "xotocross list of ports for the listeners" }
...
variable "xotocross-subdomains" { description = "xotocross list of subdomains to create" }
