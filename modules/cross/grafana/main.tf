...
provider "grafana" {
  url  = var.environment == "production" ? "https://grafana.${var.xtcross-service-name}.${var.xtcross-domain-name}.com" : "http://grafana.${var.xtcross-service-name}.${var.environment}.${var.xtcross-domain-name}.com"
